...
# User-data: Basic authentication
...
- In this project, i implemented a `Basic Authentication`. 

- In the industry, you should not implement your own Session authentication system. You should use a module or framework to do it(like in Python-Flask: Flask-HTTPAuth). Here, for the learning purpose, we will walk through each step of this mechanism to understand it by doing.
